...
const FooterContact = lazy(() => import('./FooterContact'));
...
function Footer() {
    ...
    useEffect(() => {
        const handleSBV = () => {
            ...
            if (sttElement) {
                ...
                sttElement.classList.toggle("show", show);
                if (show) {
                    sttElement.addEventListener('click', handleClk);
                } else {
                    sttElement.removeEventListener('click', handleClk);
                }
            }
        };
    ...
    return (
        <>
            <div className='scrollToTop' id="stt"></div>
            <footer>
                <div id='footerContact'>
                    <div id='contactInfo' itemScope itemType='https://schema.org/Zoo https://schema.org/TouristAttraction'>
                        ...
                        <h3>
                            <a href={addURL} target='_blank' rel="noreferrer" itemProp='address'>
                                Warszawa, Al. Jerozolimskie 200<br />(Wejście od strony ul. Łopuszańskiej)<br />
                            </a>
                            <span id='workHours'>
                                <p itemProp="openingHours" content="Mo-Fr, 10:00-19:00">Poniedziałek - Piątek: 10-19</p>
                                <p itemProp='Sa,Su 10:00-20:00'>Sobota - Niedziela: 10-20</p>
                            </span>
                        </h3>
                        ...
                        <h3 className='contactInfoElement social'>
