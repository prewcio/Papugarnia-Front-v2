...
function Cennik() {
    const [nPrice, setnPrice] = useState(31);
    const [uPrice, setuPrice] = useState(26);
    const [br1Price, setbr1Price] = useState(50);
    const [br1dPrice, setbr1dPrice] = useState(20);
    const [br2Price, setbr2Price] = useState(80);
    const [br2dPrice, setbr2dPrice] = useState(20);
    const [bgnPrice, setbgnPrice] = useState(29);
    const [bguPrice, setbguPrice] = useState(24);
    const [fPrice, setfPrice] = useState(7);

    useEffect(() => {
        const promise = fetch(process.env.REACT_APP_API_URL+'/api/getPrices44');
        promise.then((res) => {
            res.json().then(data => {
            ...
            <div id='cennik-table'>
                ...
                <div className='ticket'>
                    <h2 className='name'>Bilet Ulgowy
                        <p>Dzieci, uczniowie, studenci (do 26 r.ż.), emeryci, renciści</p>
                    </h2>
                ...
                <div className='ticket'>
                    <h2 className='name'>Bilet Grupowy Normalny
                    <p>Grupa od 15 osób dorośli</p></h2>
                    <h2 className='price'>{bgnPrice} zł/os.</h2>
                </div>
                <div className='ticket'>
                    <h2 className='name'>Bilet Grupowy Ulgowy
                    <p>Grupa od 15 osób: dzieci, emeryci, studenci</p></h2>
